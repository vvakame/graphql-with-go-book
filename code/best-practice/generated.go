...
type ComplexityRoot struct {
	...
	Event struct {
		Id         func(childComplexity int) int
		Name       func(childComplexity int) int
		CircleList func(childComplexity int, first *int) int
	}

	Query struct {
		EventList func(childComplexity int, first *int) int
	}
}

type QueryResolver interface {
	EventList(ctx context.Context, first *int) ([]Event, error)
}

func field_Event_circleList_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Circle.event":
		if e.complexity.Circle.Event == nil {
			break
		}

		return e.complexity.Circle.Event(childComplexity), true
	...
	case "Event.circleList":
		if e.complexity.Event.CircleList == nil {
			break
		}

		args, err := field_Event_circleList_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Event.CircleList(childComplexity, args["first"].(*int)), true
	...
	case "Query.eventList":
		...
		return e.complexity.Query.EventList(childComplexity, args["first"].(*int)), true
...
func (ec *executionContext) _Circle(ctx context.Context, sel ast.SelectionSet, obj *Circle) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "event":
			out.Values[i] = ec._Circle_event(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
// nolint: vetshadow
func (ec *executionContext) _Circle_id(ctx context.Context, field graphql.CollectedField, obj *Circle) graphql.Marshaler {
...
// nolint: vetshadow
func (ec *executionContext) _Circle_name(ctx context.Context, field graphql.CollectedField, obj *Circle) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Circle",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Circle_event(ctx context.Context, field graphql.CollectedField, obj *Circle) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Circle",
		Args:   nil,
		Field:  field,
...
func (ec *executionContext) _Event(ctx context.Context, sel ast.SelectionSet, obj *Event) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "circleList":
			out.Values[i] = ec._Event_circleList(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
// nolint: vetshadow
func (ec *executionContext) _Event_circleList(ctx context.Context, field graphql.CollectedField, obj *Event) graphql.Marshaler {
...
func (ec *executionContext) _Query_eventList(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Query().EventList(ctx, args["first"].(*int))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
