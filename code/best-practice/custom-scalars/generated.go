	...
	for i, field := range fields {
		...
		case "sample":
			...
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_sample(ctx, field)
				wg.Done()
			}(i, field)
		case "__type":
...
// nolint: vetshadow
func (ec *executionContext) _Query_sample(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(ctx context.Context) (interface{}, error) {
		return ec.resolvers.Query().Sample(ctx)
	})
	if resTmp == nil {
		return graphql.Null
	}
	...
	return ec._Sample(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Sample(ctx context.Context, sel ast.SelectionSet, obj *Sample) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, sampleImplementors)
	...
	for i, field := range fields {
		...
		case "value":
			out.Values[i] = ec._Sample_value(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
// nolint: vetshadow
func (ec *executionContext) _Sample_id(ctx context.Context, field graphql.CollectedField, obj *Sample) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Sample",
		Args:   nil,
		Field:  field,
...
// nolint: vetshadow
func (ec *executionContext) _Sample_value(ctx context.Context, field graphql.CollectedField, obj *Sample) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "Sample",
		Args:   nil,
		Field:  field,
	...
	return MarshalGraphQLInt64Scalar(*res)
}
